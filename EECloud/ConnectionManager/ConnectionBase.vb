Friend MustInherit Class ConnectionBase
    Implements IConnectionBase
...
#Region "Events"
    Public Custom Event OnReceiveMessage As EventHandler(Of ReceiveMessage) Implements IConnectionBase.OnReceiveMessage
    ...
    Public Custom Event OnDisconnect As EventHandler(Of EventArgs) Implements IConnectionBase.OnDisconnect
    ...
    Public Custom Event OnReceiveAccess As EventHandler(Of Access_ReceiveMessage) Implements IConnectionBase.OnReceiveAccess
    ...
    Public Custom Event OnReceiveAdd As EventHandler(Of Add_ReceiveMessage) Implements IConnectionBase.OnReceiveAdd
    ...
    Public Custom Event OnReceiveAutoText As EventHandler(Of AutoText_ReceiveMessage) Implements IConnectionBase.OnReceiveAutoText
    ...
    Public Custom Event OnReceiveBlockPlace As EventHandler(Of BlockPlace_ReceiveMessage) Implements IConnectionBase.OnReceiveBlockPlace
    ...
    Public Custom Event OnReceiveClear As EventHandler(Of Clear_ReceiveMessage) Implements IConnectionBase.OnReceiveClear
    ...
    Public Custom Event OnReceiveCoin As EventHandler(Of Coin_ReceiveMessage) Implements IConnectionBase.OnReceiveCoin
    ...
    Public Custom Event OnReceiveCoinDoorPlace As EventHandler(Of CoinDoorPlace_ReceiveMessage) Implements IConnectionBase.OnReceiveCoinDoorPlace
    ...
    Public Custom Event OnReceiveCrown As EventHandler(Of Crown_ReceiveMessage) Implements IConnectionBase.OnReceiveCrown
    ...
    Public Custom Event OnReceiveFace As EventHandler(Of Face_ReceiveMessage) Implements IConnectionBase.OnReceiveFace
    ...
    Public Custom Event OnReceiveGiveFireWizard As EventHandler(Of GiveFireWizard_ReceiveMessage) Implements IConnectionBase.OnReceiveGiveFireWizard
    ...
    Public Custom Event OnReceiveGiveGrinch As EventHandler(Of GiveGrinch_ReceiveMessage) Implements IConnectionBase.OnReceiveGiveGrinch
    ...
    Public Custom Event OnReceiveGiveWitch As EventHandler(Of GiveWitch_ReceiveMessage) Implements IConnectionBase.OnReceiveGiveWitch
    ...
    Public Custom Event OnReceiveGiveWizard As EventHandler(Of GiveWizard_ReceiveMessage) Implements IConnectionBase.OnReceiveGiveWizard
    ...
    Public Custom Event OnReceiveGodMode As EventHandler(Of GodMode_ReceiveMessage) Implements IConnectionBase.OnReceiveGodMode
    ...
    Public Custom Event OnReceiveGroupDisallowedJoin As EventHandler(Of GroupDisallowedJoin_ReceiveMessage) Implements IConnectionBase.OnReceiveGroupDisallowedJoin
    ...
    Public Custom Event OnReceiveHideKey As EventHandler(Of HideKey_ReceiveMessage) Implements IConnectionBase.OnReceiveHideKey
    ...
    Public Custom Event OnReceiveInfo As EventHandler(Of Info_ReceiveMessage) Implements IConnectionBase.OnReceiveInfo
    ...
    Public Custom Event OnReceiveInit As EventHandler(Of Init_ReceiveMessage) Implements IConnectionBase.OnReceiveInit
    ...
    Public Custom Event OnReceiveLabelPlace As EventHandler(Of LabelPlace_ReceiveMessage) Implements IConnectionBase.OnReceiveLabelPlace
    ...
    Public Custom Event OnReceiveLeft As EventHandler(Of Left_ReceiveMessage) Implements IConnectionBase.OnReceiveLeft
    ...
    Public Custom Event OnReceiveLostAccess As EventHandler(Of LostAccess_ReceiveMessage) Implements IConnectionBase.OnReceiveLostAccess
    ...
    Public Custom Event OnReceiveModMode As EventHandler(Of ModMode_ReceiveMessage) Implements IConnectionBase.OnReceiveModMode
    ...
    Public Custom Event OnReceiveMove As EventHandler(Of Move_ReceiveMessage) Implements IConnectionBase.OnReceiveMove
    ...
    Public Custom Event OnReceivePortalPlace As EventHandler(Of PortalPlace_ReceiveMessage) Implements IConnectionBase.OnReceivePortalPlace
    ...
    Public Custom Event OnReceiveRefreshShop As EventHandler(Of RefreshShop_ReceiveMessage) Implements IConnectionBase.OnReceiveRefreshShop
    ...
    Public Custom Event OnReceiveReset As EventHandler(Of Reset_ReceiveMessage) Implements IConnectionBase.OnReceiveReset
    ...
    Public Custom Event OnReceiveSaveDone As EventHandler(Of SaveDone_ReceiveMessage) Implements IConnectionBase.OnReceiveSaveDone
    ...
    Public Custom Event OnReceiveSay As EventHandler(Of Say_ReceiveMessage) Implements IConnectionBase.OnReceiveSay
    ...
    Public Custom Event OnReceiveSayOld As EventHandler(Of SayOld_ReceiveMessage) Implements IConnectionBase.OnReceiveSayOld
    ...
    Public Custom Event OnReceiveShowKey As EventHandler(Of ShowKey_ReceiveMessage) Implements IConnectionBase.OnReceiveShowKey
    ...
    Public Custom Event OnReceiveSilverCrown As EventHandler(Of SilverCrown_ReceiveMessage) Implements IConnectionBase.OnReceiveSilverCrown
    ...
    Public Custom Event OnReceiveSoundPlace As EventHandler(Of SoundPlace_ReceiveMessage) Implements IConnectionBase.OnReceiveSoundPlace
    ...
    Public Custom Event OnReceiveTeleport As EventHandler(Of Teleport_ReceiveMessage) Implements IConnectionBase.OnReceiveTeleport
    ...
    Public Custom Event OnReceiveUpdateMeta As EventHandler(Of UpdateMeta_ReceiveMessage) Implements IConnectionBase.OnReceiveUpdateMeta
    ...
    Public Custom Event OnReceiveUpgrade As EventHandler(Of Upgrade_ReceiveMessage) Implements IConnectionBase.OnReceiveUpgrade
    ...
    Public Custom Event OnReceiveWrite As EventHandler(Of Write_ReceiveMessage) Implements IConnectionBase.OnReceiveWrite
    ...
    Public Custom Event OnSendMessage As EventHandler(Of SendMessage) Implements IConnectionBase.OnSendMessage
    ...
    Public Custom Event OnSendInit As EventHandler(Of SendEventArgs(Of Init_SendMessage)) Implements IConnectionBase.OnSendInit
    ...
    Public Custom Event OnSendInit2 As EventHandler(Of SendEventArgs(Of Init2_SendMessage)) Implements IConnectionBase.OnSendInit2
    ...
    Public Custom Event OnSendBlockPlace As EventHandler(Of SendEventArgs(Of BlockPlace_SendMessage)) Implements IConnectionBase.OnSendBlockPlace
    ...
    Public Custom Event OnSendCoindoorPlace As EventHandler(Of SendEventArgs(Of CoinDoorPlace_SendMessage)) Implements IConnectionBase.OnSendCoindoorPlace
    ...
    Public Custom Event OnSendSoundPlace As EventHandler(Of SendEventArgs(Of SoundPlace_SendMessage)) Implements IConnectionBase.OnSendSoundPlace
    ...
    Public Custom Event OnSendPortalPlace As EventHandler(Of SendEventArgs(Of PortalPlace_SendMessage)) Implements IConnectionBase.OnSendPortalPlace
    ...
    Public Custom Event OnSendLabelPlace As EventHandler(Of SendEventArgs(Of LabelPlace_SendMessage)) Implements IConnectionBase.OnSendLabelPlace
    ...
    Public Custom Event OnSendCoin As EventHandler(Of SendEventArgs(Of Coin_SendMessage)) Implements IConnectionBase.OnSendCoin
    ...
    Public Custom Event OnSendPressRedKey As EventHandler(Of SendEventArgs(Of PressRedKey_SendMessage)) Implements IConnectionBase.OnSendPressRedKey
    ...
    Public Custom Event OnSendPressGreenKey As EventHandler(Of SendEventArgs(Of PressGreenKey_SendMessage)) Implements IConnectionBase.OnSendPressGreenKey
    ...
    Public Custom Event OnSendPressBlueKey As EventHandler(Of SendEventArgs(Of PressBlueKey_SendMessage)) Implements IConnectionBase.OnSendPressBlueKey
    ...
    Public Custom Event OnSendGetCrown As EventHandler(Of SendEventArgs(Of GetCrown_SendMessage)) Implements IConnectionBase.OnSendGetCrown
    ...
    Public Custom Event OnSendTouchDiamond As EventHandler(Of SendEventArgs(Of TouchDiamond_SendMessage)) Implements IConnectionBase.OnSendTouchDiamond
    ...
    Public Custom Event OnSendCompleteLevel As EventHandler(Of SendEventArgs(Of CompleteLevel_SendMessage)) Implements IConnectionBase.OnSendCompleteLevel
    ...
    Public Custom Event OnSendGodMode As EventHandler(Of SendEventArgs(Of GodMode_SendMessage)) Implements IConnectionBase.OnSendGodMode
    ...
    Public Custom Event OnSendModMode As EventHandler(Of SendEventArgs(Of ModMode_SendMessage)) Implements IConnectionBase.OnSendModMode
    ...
    Public Custom Event OnSendMove As EventHandler(Of SendEventArgs(Of Move_SendMessage)) Implements IConnectionBase.OnSendMove
    ...
    Public Custom Event OnSendSay As EventHandler(Of SendEventArgs(Of Say_SendMessage)) Implements IConnectionBase.OnSendSay
    ...
    Public Custom Event OnSendAutoSay As EventHandler(Of SendEventArgs(Of AutoSay_SendMessage)) Implements IConnectionBase.OnSendAutoSay
    ...
    Public Custom Event OnSendAccess As EventHandler(Of SendEventArgs(Of Access_SendMessage)) Implements IConnectionBase.OnSendAccess
    ...
    Public Custom Event OnSendChangeFace As EventHandler(Of SendEventArgs(Of ChangeFace_SendMessage)) Implements IConnectionBase.OnSendChangeFace
    ...
    Public Custom Event OnSendSaveWorld As EventHandler(Of SendEventArgs(Of SaveWorld_SendMessage)) Implements IConnectionBase.OnSendSaveWorld
    ...
    Public Custom Event OnSendChangeWorldName As EventHandler(Of SendEventArgs(Of ChangeWorldName_SendMessage)) Implements IConnectionBase.OnSendChangeWorldName
    ...
    Public Custom Event OnSendChangeWorldEditKey As EventHandler(Of SendEventArgs(Of ChangeWorldEditKey_SendMessage)) Implements IConnectionBase.OnSendChangeWorldEditKey
    ...
    Public Custom Event OnSendClearWorld As EventHandler(Of SendEventArgs(Of ClearWorld_SendMessage)) Implements IConnectionBase.OnSendClearWorld
    ...
    Public Custom Event OnSendKillWorld As EventHandler(Of SendEventArgs(Of KillWorld_SendMessage)) Implements IConnectionBase.OnSendKillWorld
...
#Region "Methods"
    ...
    Protected Sub RaiseReciveEvent(message As ReceiveMessage)
        RaiseEvent OnReceiveMessage(Me, message)
        Select Case message.GetType
            Case GetType(Init_ReceiveMessage)
                Dim m As Init_ReceiveMessage = CType(message, Init_ReceiveMessage)
                RaiseEvent OnReceiveInit(Me, m)

            Case GetType(GroupDisallowedJoin_ReceiveMessage)
                Dim m As GroupDisallowedJoin_ReceiveMessage = CType(message, GroupDisallowedJoin_ReceiveMessage)
                RaiseEvent OnReceiveGroupDisallowedJoin(Me, m)

            Case GetType(Info_ReceiveMessage)
                Dim m As Info_ReceiveMessage = CType(message, Info_ReceiveMessage)
                RaiseEvent OnReceiveInfo(Me, m)

            Case GetType(Upgrade_ReceiveMessage)
                Dim m As Upgrade_ReceiveMessage = CType(message, Upgrade_ReceiveMessage)
                RaiseEvent OnReceiveUpgrade(Me, m)

            Case GetType(UpdateMeta_ReceiveMessage)
                Dim m As UpdateMeta_ReceiveMessage = CType(message, UpdateMeta_ReceiveMessage)
                RaiseEvent OnReceiveUpdateMeta(Me, m)

            Case GetType(Add_ReceiveMessage)
                Dim m As Add_ReceiveMessage = CType(message, Add_ReceiveMessage)
                RaiseEvent OnReceiveAdd(Me, m)

            Case GetType(Left_ReceiveMessage)
                Dim m As Left_ReceiveMessage = CType(message, Left_ReceiveMessage)
                RaiseEvent OnReceiveLeft(Me, m)

            Case GetType(Move_ReceiveMessage)
                Dim m As Move_ReceiveMessage = CType(message, Move_ReceiveMessage)
                RaiseEvent OnReceiveMove(Me, m)

            Case GetType(Coin_ReceiveMessage)
                Dim m As Coin_ReceiveMessage = CType(message, Coin_ReceiveMessage)
                RaiseEvent OnReceiveCoin(Me, m)

            Case GetType(Crown_ReceiveMessage)
                Dim m As Crown_ReceiveMessage = CType(message, Crown_ReceiveMessage)
                RaiseEvent OnReceiveCrown(Me, m)

            Case GetType(SilverCrown_ReceiveMessage)
                Dim m As SilverCrown_ReceiveMessage = CType(message, SilverCrown_ReceiveMessage)
                RaiseEvent OnReceiveSilverCrown(Me, m)
            Case GetType(Face_ReceiveMessage)
                Dim m As Face_ReceiveMessage = CType(message, Face_ReceiveMessage)
                RaiseEvent OnReceiveFace(Me, m)

            Case GetType(ShowKey_ReceiveMessage)
                Dim m As ShowKey_ReceiveMessage = CType(message, ShowKey_ReceiveMessage)
                RaiseEvent OnReceiveShowKey(Me, m)

            Case GetType(HideKey_ReceiveMessage)
                Dim m As HideKey_ReceiveMessage = CType(message, HideKey_ReceiveMessage)
                RaiseEvent OnReceiveHideKey(Me, m)

            Case GetType(Say_ReceiveMessage)
                Dim m As Say_ReceiveMessage = CType(message, Say_ReceiveMessage)
                RaiseEvent OnReceiveSay(Me, m)

            Case GetType(SayOld_ReceiveMessage)
                Dim m As SayOld_ReceiveMessage = CType(message, SayOld_ReceiveMessage)
                RaiseEvent OnReceiveSayOld(Me, m)

            Case GetType(AutoText_ReceiveMessage)
                Dim m As AutoText_ReceiveMessage = CType(message, AutoText_ReceiveMessage)
                RaiseEvent OnReceiveAutoText(Me, m)

            Case GetType(Write_ReceiveMessage)
                Dim m As Write_ReceiveMessage = CType(message, Write_ReceiveMessage)
                RaiseEvent OnReceiveWrite(Me, m)

            Case GetType(BlockPlace_ReceiveMessage)
                Dim m As BlockPlace_ReceiveMessage = CType(message, BlockPlace_ReceiveMessage)
                RaiseEvent OnReceiveBlockPlace(Me, m)

            Case GetType(CoinDoorPlace_ReceiveMessage)
                Dim m As CoinDoorPlace_ReceiveMessage = CType(message, CoinDoorPlace_ReceiveMessage)
                RaiseEvent OnReceiveCoinDoorPlace(Me, m)
                RaiseEvent OnReceiveBlockPlace(Me, m)

            Case GetType(SoundPlace_ReceiveMessage)
                Dim m As SoundPlace_ReceiveMessage = CType(message, SoundPlace_ReceiveMessage)
                RaiseEvent OnReceiveSoundPlace(Me, m)
                RaiseEvent OnReceiveBlockPlace(Me, m)

            Case GetType(PortalPlace_ReceiveMessage)
                Dim m As PortalPlace_ReceiveMessage = CType(message, PortalPlace_ReceiveMessage)
                RaiseEvent OnReceivePortalPlace(Me, m)
                RaiseEvent OnReceiveBlockPlace(Me, m)

            Case GetType(LabelPlace_ReceiveMessage)
                Dim m As LabelPlace_ReceiveMessage = CType(message, LabelPlace_ReceiveMessage)
                RaiseEvent OnReceiveLabelPlace(Me, m)
                RaiseEvent OnReceiveBlockPlace(Me, m)

            Case GetType(GodMode_ReceiveMessage)
                Dim m As GodMode_ReceiveMessage = CType(message, GodMode_ReceiveMessage)
                RaiseEvent OnReceiveGodMode(Me, m)

            Case GetType(ModMode_ReceiveMessage)
                Dim m As ModMode_ReceiveMessage = CType(message, ModMode_ReceiveMessage)
                RaiseEvent OnReceiveModMode(Me, m)

            Case GetType(Access_ReceiveMessage)
                Dim m As Access_ReceiveMessage = CType(message, Access_ReceiveMessage)
                RaiseEvent OnReceiveAccess(Me, m)

            Case GetType(LostAccess_ReceiveMessage)
                Dim m As LostAccess_ReceiveMessage = CType(message, LostAccess_ReceiveMessage)
                RaiseEvent OnReceiveLostAccess(Me, m)

            Case GetType(Teleport_ReceiveMessage)
                Dim m As Teleport_ReceiveMessage = CType(message, Teleport_ReceiveMessage)
                RaiseEvent OnReceiveTeleport(Me, m)

            Case GetType(Reset_ReceiveMessage)
                Dim m As Reset_ReceiveMessage = CType(message, Reset_ReceiveMessage)
                RaiseEvent OnReceiveReset(Me, m)

            Case GetType(Clear_ReceiveMessage)
                Dim m As Clear_ReceiveMessage = CType(message, Clear_ReceiveMessage)
                RaiseEvent OnReceiveClear(Me, m)

            Case GetType(SaveDone_ReceiveMessage)
                Dim m As SaveDone_ReceiveMessage = CType(message, SaveDone_ReceiveMessage)
                RaiseEvent OnReceiveSaveDone(Me, m)

            Case GetType(RefreshShop_ReceiveMessage)
                Dim m As RefreshShop_ReceiveMessage = CType(message, RefreshShop_ReceiveMessage)
                RaiseEvent OnReceiveRefreshShop(Me, m)

            Case GetType(GiveWizard_ReceiveMessage)
                Dim m As GiveWizard_ReceiveMessage = CType(message, GiveWizard_ReceiveMessage)
                RaiseEvent OnReceiveGiveWizard(Me, m)

            Case GetType(GiveFireWizard_ReceiveMessage)
                Dim m As GiveFireWizard_ReceiveMessage = CType(message, GiveFireWizard_ReceiveMessage)
                RaiseEvent OnReceiveGiveFireWizard(Me, m)

            Case GetType(GiveWitch_ReceiveMessage)
                Dim m As GiveWitch_ReceiveMessage = CType(message, GiveWitch_ReceiveMessage)
                RaiseEvent OnReceiveGiveWitch(Me, m)

            Case GetType(GiveGrinch_ReceiveMessage)
                Dim m As GiveGrinch_ReceiveMessage = CType(message, GiveGrinch_ReceiveMessage)
    ...
    Private Sub RaiseDisconnetEvent()
        RaiseEvent OnDisconnect(Me, EventArgs.Empty)
    End Sub
#End Region

    Public MustOverride ReadOnly Property Connected As Boolean Implements IConnectionBase.Connected

    Public MustOverride ReadOnly Property Encryption As String Implements IConnectionBase.Encryption

    Public MustOverride ReadOnly Property GetChatter(name As String) As IChatter Implements IConnectionBase.GetChatter

    Public MustOverride ReadOnly Property IsMainConnection As Boolean Implements IConnectionBase.IsMainConnection

    Public MustOverride Sub Send(message As SendMessage) Implements IConnectionBase.Send

    Public MustOverride ReadOnly Property World As World Implements IConnectionBase.World

    Public MustOverride ReadOnly Property WorldID As String Implements IConnectionBase.WorldID
End Class