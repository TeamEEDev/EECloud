Public NotInheritable Class Settings
    ...
    Public Function GetDatabaseArray(SettingName As String) As PlayerIOClient.DatabaseArray Implements ISettings.GetDatabaseArray
        Try
            Return CType(GetObj(SettingName), PlayerIOClient.DatabaseArray)
        Catch ex As Exception
            Return New PlayerIOClient.DatabaseArray
        End Try
    End Function
    ...
    Public Function GetDatabaseObject(SettingName As String) As PlayerIOClient.DatabaseObject Implements ISettings.GetDatabaseObject
        ...
        Catch ex As Exception
            Return New PlayerIOClient.DatabaseObject
        End Try
    End Function
